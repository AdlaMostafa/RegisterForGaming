  ...
  const getPasswordStrength = async (password) => {
    try {
      ...
      if (error.inner.some((e) => e.path === "password")) {
        if (
          error.inner.some((e) => e.message.includes("at least 8 characters"))
        ) {
          return "weak";
        } else if (
          error.inner.some((e) => e.message.includes("at least 13 characters"))
        ) {
          return "medium";
        }
      }
        ...
        <div className="Form2">
          <form onSubmit={handleFormSubmit}>
            ...
            <div className="SubButt2">
              <ButtonComponent
                text={isLoading ? "Loading ..." : "Register Account"}
                type="submit"
